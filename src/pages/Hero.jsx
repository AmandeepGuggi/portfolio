    ...
    return (
        <section className=' flex items-center'>
            <div>
                ...
                <AutoTyping />
                <h3 className='text-4xl font-semibold mb-5 text-[#e2a193]'>Full-Stack Developer</h3>
                ...
                <div className='flex gap-6'>
                  <a href="https://wa.me/8847548854?text==Hi%20Amandeep,%20I%20want%20to%20hire%20you">
                      <Button
                  ...
                  <a target='_blank'
                    // onClick={() => window.open("/assets/AmandeepK_resume.pdf", "_blank")}
                   href="/public/kaur_resume.pdf"
                download="Amandeep_resume.pdf" >
                          <Button
                ...
                <div className='flex items-center gap-6'>
                   <p> Follow me:</p> <div className='flex gap-4 mt-2'>
                        <a target='_blank' href="https://github.com/AmandeepGuggi"><NavItem icon="/assets/icons/github.svg" /></a>
                        <a target='_blank' href="https://www.linkedin.com/in/amandeep-guggi-a128a6347/"><NavItem icon="/assets/icons/linkedin.svg" /></a>
                        <a target='_blank' href="https://www.instagram.com/amanndeepkaurr/"><NavItem icon="/assets/icons/instagram.svg" /></a>
                    </div>
                </div>
            </div>
